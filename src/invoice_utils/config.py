...
INVOICE_UTILS_DEFAULT_RULE_TEMPLATE_NAME = os.getenv(
    "INVOICE_UTILS_DEFAULT_RULE_TEMPLATE_NAME",
    DEFAULT_RULE_TEMPLATE_NAME
)
INVOICE_UTILS_DEFAULT_RULE_TEMPLATE = str(Path(INVOICE_UTILS_TEMPLATES_DIR) / INVOICE_UTILS_DEFAULT_RULE_TEMPLATE_NAME)
