...
DEFAULT_BODY_TEMPLATE_PATH = "default_template.html"
...
INVOICE_UTILS_BODY_TEMPLATE_PATH = os.getenv("INVOICE_UTILS_BODY_TEMPLATE_PATH", DEFAULT_BODY_TEMPLATE_PATH)
